...
<head>
    <title>Code coverage report for react/vitest/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">react/vitest</a> utils.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { type FirebaseApp, FirebaseError, initializeApp } from "firebase/app";
...
let auth: Auth;
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (!firebaseApp) {
...
<span class="cstat-no" title="statement not covered" >    throw new Error("Failed to wipe firestore");</span>
  }
}
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!response.ok) {
<span class="cstat-no" title="statement not covered" >    throw new Error("Failed to wipe auth");</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    console.error("Expected a Firebase error, but received a different type.", {</span>
