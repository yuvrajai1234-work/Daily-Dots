...
<head>
    <title>Code coverage report for react/src/auth/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">react/src/auth</a> utils.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    console.error("Error reading Firebase debug log:", error);</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
}
&nbsp;
...
async function waitForCode(
  ...
  logPattern: RegExp,
  extractCodeFn: (line: string) =&gt; string | null,
  timeout = <span class="branch-0 cbranch-no" title="branch not covered" >5000,</span>
  interval = <span class="branch-0 cbranch-no" title="branch not covered" >100,</span>
): Promise&lt;string | null&gt; {
...
<span class="cstat-no" title="statement not covered" >    await new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve) =&gt; <span class="cstat-no" title="statement not covered" >setTimeout(resolve, interval))</span>;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return null;</span>
}
...
function extractOobCode(line: string): string | null {
  ...
  return url ? new URL(url).searchParams.get("oobCode") : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
}
&nbsp;
