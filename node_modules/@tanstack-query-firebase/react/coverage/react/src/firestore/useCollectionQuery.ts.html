...
<head>
    <title>Code coverage report for react/src/firestore/useCollectionQuery.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">react/src/firestore</a> useCollectionQuery.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        return await getDocsFromCache(query);</span>
      }
&nbsp;
