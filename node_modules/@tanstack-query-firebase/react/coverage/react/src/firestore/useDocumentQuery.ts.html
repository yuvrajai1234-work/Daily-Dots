...
<head>
    <title>Code coverage report for react/src/firestore/useDocumentQuery.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">react/src/firestore</a> useDocumentQuery.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { type UseQueryOptions, useQuery } from "@tanstack/react-query";
import {
  type DocumentData,
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (firestore?.source === "cache") {
<span class="cstat-no" title="statement not covered" >          return await getDocFromCache(documentRef);</span>
        }
&nbsp;
