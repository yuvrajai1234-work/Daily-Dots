...
<head>
    <title>Code coverage report for react/src/data-connect/query-client.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">react/src/data-connect</a> query-client.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ("ref" in refOrResult) {
<span class="cstat-no" title="statement not covered" >      queryRef = refOrResult.ref;</span>
