...
<head>
    <title>Code coverage report for react/src/data-connect/useDataConnectMutation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">react/src/data-connect</a> useDataConnectMutation.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    mutationFn: async (variables) =&gt; {
      const mutationRef = typeof ref === "function" ? ref(variables) : <span class="branch-1 cbranch-no" title="branch not covered" >ref;</span>
&nbsp;
